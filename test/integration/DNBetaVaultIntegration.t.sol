...
//        );
//
//        assertEq(kUSD.totalSupply(), mintAmount - redemptionAmount, "kUSD supply should decrease by redemption
// amount");
//
...
//        assertVirtualBalance(
//            address(dnVault), USDC_MAINNET, expectedDNBalance, "DN vault should be isolated from Beta strategy
// results"
//        );
//
...
//        assertVirtualBalance(address(dnVault), USDC_MAINNET, expectedDNBalance, "DN vault should receive profit
// share");
//
