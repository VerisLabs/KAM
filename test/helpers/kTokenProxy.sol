...
/// @title kTokenProxy
/// @notice Helper contract to deploy kToken via minimal proxy for testing
contract kTokenProxy {
    using LibClone for address;

    /// @notice Deploy a minimal proxy of kToken and initialize it
    /// @param implementation The kToken implementation address
