...
/// @title kMinterProxy
/// @notice Helper contract to deploy kMinter via minimal proxy for testing
contract kMinterProxy {
    using LibClone for address;

    /// @notice Deploy a minimal proxy of kMinter and initialize it
    /// @param implementation The kMinter implementation address
