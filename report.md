...
- Found in src/kStakingVault/kStakingVault.sol [Line: 75](src/kStakingVault/kStakingVault.sol#L75)
...
- Found in src/kRegistry.sol [Line: 499](src/kRegistry.sol#L499)
...
- Found in src/adapters/BaseAdapter.sol [Line: 40](src/adapters/BaseAdapter.sol#L40)
...
- Found in src/adapters/BaseAdapter.sol [Line: 63](src/adapters/BaseAdapter.sol#L63)
...
- Found in src/kRegistry.sol [Line: 262](src/kRegistry.sol#L262)
...
- Found in src/kRegistry.sol [Line: 267](src/kRegistry.sol#L267)

	```solidity
	        $.vaultsByAsset[asset].add(vault);
	```

- Found in src/kRegistry.sol [Line: 298](src/kRegistry.sol#L298)

	```solidity
	        $.vaultAdapters[vault].add(adapter);
	```

- Found in src/kRegistry.sol [Line: 310](src/kRegistry.sol#L310)

	```solidity
	        $.vaultAdapters[vault].remove(adapter);
	```

- Found in src/kStakingVault/kStakingVault.sol [Line: 118](src/kStakingVault/kStakingVault.sol#L118)

	```solidity
	        $.userRequests[msg.sender].add(requestId);
	```

- Found in src/kStakingVault/kStakingVault.sol [Line: 168](src/kStakingVault/kStakingVault.sol#L168)

	```solidity
	        $.userRequests[msg.sender].add(requestId);
	```

- Found in src/kStakingVault/kStakingVault.sol [Line: 190](src/kStakingVault/kStakingVault.sol#L190)

	```solidity
	        $.userRequests[msg.sender].remove(requestId);
	```

- Found in src/kStakingVault/kStakingVault.sol [Line: 217](src/kStakingVault/kStakingVault.sol#L217)
