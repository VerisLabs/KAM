...
contract ConfigureAdapterPermissionsScript is Script, DeploymentManager {
    function run() public {
        ...
        registry.setAdapterAllowedSelector(
            existing.contracts.dnVaultAdapterUSDC, existing.contracts.mockERC7540USDC, requestDepositSelector, true
        );
        registry.setAdapterAllowedSelector(
            existing.contracts.dnVaultAdapterUSDC, existing.contracts.mockERC7540USDC, depositSelector, true
        );
        registry.setAdapterAllowedSelector(
            existing.contracts.dnVaultAdapterUSDC, existing.contracts.mockERC7540USDC, requestRedeemSelector, true
        );
        registry.setAdapterAllowedSelector(
            existing.contracts.dnVaultAdapterUSDC, existing.contracts.mockERC7540USDC, redeemSelector, true
        );
        // Allow wallet transfer for USDC
        registry.setAdapterAllowedSelector(
            existing.contracts.dnVaultAdapterUSDC, existing.contracts.mockWalletUSDC, transferSelector, true
        );
        ...
        registry.setAdapterAllowedSelector(
            existing.contracts.dnVaultAdapterWBTC, existing.contracts.mockERC7540WBTC, requestDepositSelector, true
        );
        registry.setAdapterAllowedSelector(
            existing.contracts.dnVaultAdapterWBTC, existing.contracts.mockERC7540WBTC, depositSelector, true
        );
        registry.setAdapterAllowedSelector(
            existing.contracts.dnVaultAdapterWBTC, existing.contracts.mockERC7540WBTC, requestRedeemSelector, true
        );
        registry.setAdapterAllowedSelector(
            existing.contracts.dnVaultAdapterWBTC, existing.contracts.mockERC7540WBTC, redeemSelector, true
        );
        ...
        registry.setAdapterAllowedSelector(
            existing.contracts.alphaVaultAdapter, existing.contracts.mockWalletUSDC, transferSelector, true
        );
        console.log("   - Allowed transfer function on mockWalletUSDC");
        ...
        registry.setAdapterAllowedSelector(
            existing.contracts.betaVaultAdapter, existing.contracts.mockWalletUSDC, transferSelector, true
        );
        console.log("   - Allowed transfer function on mockWalletUSDC");
