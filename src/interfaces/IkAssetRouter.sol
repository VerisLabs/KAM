...
interface IkAssetRouter {
    function kAssetPush(address targetVault, address _asset, uint256 amount, uint256 batchId) external payable;
    function kAssetRequestPull(address targetVault, address _asset, uint256 amount, uint256 batchId) external payable;
